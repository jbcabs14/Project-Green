  ...
  factory MainFormatException.fromCode(String code) {
    switch (code) {
      case 'invalid-email-format':
        return const MainFormatException(
      ...
      case 'invalid-ssn-format':
        return const MainFormatException(
            'The Social Security Number format is invalid. Please enter a valid SSN.');
      ...
      case 'invalid-hex-color-format':
        return const MainFormatException(
            'The hex color format is invalid. Please enter a valid hex color code.');
      ...
      case 'invalid-password-format':
        return const MainFormatException(
            'The password format is invalid. Passwords must be at least 6 characters long and include a mix of letters, numbers, and special characters.');
