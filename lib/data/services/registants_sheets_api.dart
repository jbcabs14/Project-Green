//import 'package:proj_hiraya/features/main/models/registrants/registrant.dart';
...
/*class RegistrantsSheetsApi {
  ...
  static Worksheet? getRegistrantSheet(Spreadsheet spreadsheet,
    ...
    try {
      ...
      if (kDebugMode)
        print('Something went wrong with getting the registrant sheets. $e');
  ...
  static Future<bool> updateRegistrant(Registrant registrant) async {
    ...
    return registrantSheet!.values.insertRow(
        await getRowIndexByEmail(registrant.email), registrant.toList());
  }
}*/
